...
for m in range(1001):
    initial_val = list(jr.uniform(keys[m], shape=(6,), minval=-3, maxval=3))+ list(jr.uniform(keys[m], shape=(10,), minval=0, maxval= 3))  # Generate\random numbers between 0 and 3
    ...
    np.save(f'dif_cost_p.npy', best_params_arr)
    np.save(f'dif_cost_v.npy', best_values_arr)
