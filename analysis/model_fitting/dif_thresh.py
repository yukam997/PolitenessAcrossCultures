...
for m in range(1001):
    initial_val = list(jr.uniform(keys[m], shape=(12,), minval=-3, maxval=3))+ list(jr.uniform(keys[m], shape=(15,), minval=0, maxval= 3))  # Generate\random numbers between 0 and 3
    ...
    np.save(f'dif_thresh_p.npy', best_params_arr)
    np.save(f'dif_thresh_v.npy', best_values_arr)
