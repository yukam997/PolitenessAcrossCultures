...
def easy_wrapped_loss(x):
    x_UK = [-0.1610901653766632, -1.5463283061981201, -0.8385720252990723, -0.6723966002464294, 0.25519952178001404, -0.5561386942863464, 1.8897273540496826, x, 0.0023782984353601933, 0.4264898896217346, 1.7800384759902954, 1.1601382493972778, 1.0630438327789307, 0.5169200897216797, 3.795074462890625]
    x_US = [0.19965657591819763, 6.073495388031006, -0.9819183945655823, 0.647635281085968, 0.43982991576194763, 0.8020678162574768, 1.4228870526267201e-08, x, 2.400108112254884e-09, 0.4377947449684143, 5.935051441192627, 4.291709899902344, 0.025035476312041283, 0.4777671694755554, 4.93689489364624]
...
for m in range(1001):
    ...
    np.save(f'same_inf_p.npy', best_params_arr)
    np.save(f'same_inf_v.npy', best_values_arr)
